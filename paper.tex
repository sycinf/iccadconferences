...
A complementing technique is also proposed to perform static deadlock analysis for the generated accelerator network.
...
on using representative dataset as input and% for certain type of problems, simulation results 
